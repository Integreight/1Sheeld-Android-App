...
public enum UIShield {
	...
	LED_SHIELD(1, "LED",R.drawable.shields_activity_strip_1,R.drawable.shields_activity_strip_1_bw,R.drawable.shields_activity_small_strip_1,R.drawable.shields_activity_led_symbol, false),
	NOTIFICATION_SHIELD(2, "Notification",R.drawable.shields_activity_strip_2,R.drawable.shields_activity_strip_2_bw,R.drawable.shields_activity_small_strip_2,R.drawable.shields_activity_vibration_symbol, false),
	SEVENSEGMENT_SHIELD(3, "Seven Segment",R.drawable.shields_activity_strip_3,R.drawable.shields_activity_strip_3_bw,R.drawable.shields_activity_small_strip_3,R.drawable.shields_activity_seven_segment_symbol, false),
	BUZZER_SHIELD(4, "Buzzer",R.drawable.shields_activity_strip_4,R.drawable.shields_activity_strip_4_bw,R.drawable.shields_activity_small_strip_4,R.drawable.shields_activity_buzzer_symbol, false),
	MIC_SHIELD(5, "Mic",R.drawable.shields_activity_strip_5,R.drawable.shields_activity_strip_5_bw,R.drawable.shields_activity_small_strip_5,R.drawable.shields_activity_mic_symbol ,false),
	KEYPAD_SHIELD(6, "Keypad",R.drawable.shields_activity_strip_6,R.drawable.shields_activity_strip_6_bw,R.drawable.shields_activity_small_strip_6,R.drawable.shields_activity_keypad_symbol ,false),
	SLIDER_SHIELD(7, "Sliders",R.drawable.shields_activity_strip_7,R.drawable.shields_activity_strip_7_bw,R.drawable.shields_activity_small_strip_7,R.drawable.shields_activity_sliders_symbol ,false),
	...
	GAMEDPAD_SHIELD(15, "Game Pad",R.drawable.shields_activity_strip_15,R.drawable.shields_activity_strip_15_bw,R.drawable.shields_activity_small_strip_15,R.drawable.shields_activity_gamepad_symbol ,false),
	INTERNET_SHIELD(16, "Internet",R.drawable.shields_activity_strip_16,R.drawable.shields_activity_strip_16_bw,R.drawable.shields_activity_small_strip_16,R.drawable.shields_activity_internet_symbol ,false),
	FOURSQUARE_SHIELD(17, "Foursquare",R.drawable.shields_activity_strip_17,R.drawable.shields_activity_strip_17_bw,R.drawable.shields_activity_small_strip_17,R.drawable.shields_activity_foursquare_symbol ,false),
	...
	SMS_SHIELD(19, "SMS",R.drawable.shields_activity_strip_19,R.drawable.shields_activity_strip_19_bw,R.drawable.shields_activity_small_strip_19,R.drawable.shields_activity_sms_symbol ,false),
	MUSICPLAYER_SHIELD(20, "Music Player",R.drawable.shields_activity_strip_20,R.drawable.shields_activity_strip_20_bw,R.drawable.shields_activity_small_strip_20,R.drawable.shields_activity_musicplayer_symbol ,false),
	GYROSCOPE_SHIELD(21, "Gyroscope",R.drawable.shields_activity_strip_21,R.drawable.shields_activity_strip_21_bw,R.drawable.shields_activity_small_strip_21,R.drawable.shields_activity_gyroscope_symbol ,false),
