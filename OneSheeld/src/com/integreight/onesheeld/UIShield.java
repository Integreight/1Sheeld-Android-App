...
public enum UIShield {
	...
	FACEBOOK_SHIELD(13, "Facebook",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_facebook_symbol ,false),
	TWITTER_SHIELD(14, "Twitter",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_twitter_symbol ,false),
	GAMEDPAD_SHIELD(15, "Game Pad",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_gamepad_symbol ,false),
	INTERNET_SHIELD(16, "Internet",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_internet_symbol ,false),
	FOURSQUARE_SHIELD(17, "Foursquare",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_foursquare_symbol ,false),
	GPS_SHIELD(18, "GPS",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_gps_symbol ,false),
	SMS_SHIELD(19, "SMS",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_sms_symbol ,false),
	MUSICPLAYER_SHIELD(20, "Music Player",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_musicplayer_symbol ,false),
	GYROSCOPE_SHIELD(21, "Gyroscope",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_gyroscope_symbol ,false),
	FLASHLIGHT_SHIELD(22, "Flashlight",R.drawable.shields_activity_gray_strip,R.drawable.shields_activity_gray_strip_bw,R.drawable.shields_activity_gray_small_strip,R.drawable.shields_activity_flashlight_symbol ,false);
