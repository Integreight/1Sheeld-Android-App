...
//	 public static final String BUNDLE_EXTRA_STRING_MESSAGE = "com.yourcompany.yourapp.extra.STRING_MESSAGE"; //$NON-NLS-1$
	 public static final String BUNDLE_EXTRA_PIN_NUMBER = "com.yourcompany.yourapp.extra.PIN_NUMBER"; //$NON-NLS-1$
	 public static final String BUNDLE_EXTRA_OUTPUT = "com.yourcompany.yourapp.extra.OUTPUT"; //$NON-NLS-1$
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(BUNDLE_EXTRA_PIN_NUMBER)||!bundle.containsKey(BUNDLE_EXTRA_OUTPUT))
        {
...
//        if (TextUtils.isEmpty(bundle.getInt(BUNDLE_EXTRA_PIN_NUMBER)))
//        {
//            if (Constants.IS_LOGGABLE)
//            {
//                Log.e(Constants.LOG_TAG,
...
//        }
     ...
     */
    public static Bundle generateBundle(final Context context, final int pin, final boolean output)
    {
