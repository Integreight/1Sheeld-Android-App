...
import com.integreight.onesheeld.utils.customviews.utils.LockPatternUtils;
...
public class LockPatternViewEx extends View {
    ...
    private Paint mBackLayerPaint = new Paint();
    ...
    public LockPatternViewEx(Context context, AttributeSet attrs) {
        ...
        mRegularColor = getResources().getColor(R.color.offWhite);
...
//                        R.attr.color_lock_pattern_view_error));
        mSuccessColor = getResources().getColor(R.color.offWhite);
//                Resources.resolveAttribute(getContext(),
//                        R.attr.color_lock_pattern_view_success));
        ...
        mBackLayerPaint.setAntiAlias(true);
        mBackLayerPaint.setDither(true);
...
//    }
    ...
    private void cancelLineAnimations() {
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                if (state.lineAnimator != null && Build.VERSION.SDK_INT >= 11) {
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY,
        ...
        mBackLayerPaint.setColor(0x3B000000);
//        mBackLayerPaint.setAlpha((int) (40 * 255));
        canvas.drawCircle(centerX, centerY, size*2 , mBackLayerPaint);
